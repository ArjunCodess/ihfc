...
GPIO34 and GPIO35 are input-only pins, which suits the ultrasonic ECHO and left IR inputs. A 5 V ultrasonic ECHO signal needs a divider before GPIO34. The planned divider is 10~k$\Omega$ from ECHO to GPIO34 and 15~k$\Omega$ from GPIO34 to ground. Both IR outputs must remain within the ESP32's 3.3 V input limit. Remove the L298N ENA and ENB jumpers so GPIO33 and GPIO5 can control speed.
