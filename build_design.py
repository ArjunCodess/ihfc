...
\vspace{9mm}
{\Huge\bfseries Two simple robots.\par}
\vspace{7mm}
{\Large SealBot and CareBot\par}
\vspace{12mm}
\rule{\linewidth}{1pt}
\vspace{8mm}
{\large Rs 8,790 planned / Rs 10,000 maximum\par}
...
\vspace{6mm}
\textbf{CareBot}\par
Deliver all ten kits in three batches $\rightarrow$ capture one patient
$\rightarrow$ inspect its colour $\rightarrow$ deliver directly $\rightarrow$ repeat.\par
\vfill
\color{black}
The simpler design, with sample handling added\par
6 September 2026\par
Based on the supplied Rulebook-2026.pdf and official camera documentation.\par
Borrowed tools and practice surface assumed. Nine-day school build.\par
One patient pocket. One sample tray. No rotary magazine or patient elevator.\par
All task types are covered; full completion in two minutes is not guaranteed.
\end{titlepage}
\pagenumbering{roman}
