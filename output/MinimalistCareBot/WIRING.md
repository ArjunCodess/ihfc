...
On boot/reset, the firmware configures the PCA9685 for 50 Hz, commands channels 0 through 4 to their rest positions, performs its sensor checks, and starts the route automatically. Channels 0 and 2 move from 90 degrees down to 20 degrees. Channel 1 moves from 90 degrees up to 160 degrees. Confirm the actual servo socket numbers and safe angles before loading the bins.
